...
generateSamples <- function(population, population_name, n_phase2, stratum_variable, outcome_variable, target_variables_1, target_variables_2, model_formula, digit){
  ...
  dir.create(file.path(mainDir, paste0(population_name, "/RS_exactAlloc")), showWarnings = FALSE)
  dir.create(file.path(mainDir, paste0(population_name, "/WRS_exactAlloc")), showWarnings = FALSE)
