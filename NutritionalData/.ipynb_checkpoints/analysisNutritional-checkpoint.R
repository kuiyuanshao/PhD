...
for (i in 1:n){
  ...
  for (j in 1:length(foldernames)){
    ...
    load(paste0("/nesi/project/uoa03789/PhD/SamplingDesigns/NutritionalSample/MICE", 
    ...
    load(paste0("/nesi/project/uoa03789/PhD/SamplingDesigns/NutritionalSample/MIXGB", 
    ...
    load(paste0("/nesi/project/uoa03789/PhD/SamplingDesigns/NutritionalSample/GANs", 
...
save(result_df.1, result_df.2, file = "/nesi/project/uoa03789/PhD/SamplingDesigns/NutritionalSample/result_imputation.RData")
