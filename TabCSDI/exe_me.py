...
foldername = "./save/diet_fold" + str(args.nfold) + "_" + current_time + "/"
...
for i in range(1, 100):
    train_loader, valid_loader, test_loader = get_dataloader(
        ...
        name="SampleData_000" + str(i) + ".RData.csv"
    )
    ...
    if args.modelfolder == "":
        ...
        model.load_state_dict(torch.load("./save/" + "diet_fold5_20240416_052953" + "/model.pth"))
    print("---------------Start testing---------------")
    evaluate(model, test_loader, nsample=args.nsample, scaler=1, foldername=foldername, filename="SampleData_000" + str(i))
