...
if args.modelfolder == "":
    ...
    model.load_state_dict(torch.load("./save/" + "breast_fold5_20240414_221335" + "/model.pth"))
print("---------------Start testing---------------")
...
#pd.DataFrame(all_target.numpy()).to_csv("observed_data.csv", sep = "\t")
#pd.DataFrame(all_generated_samples.numpy()).to_csv("generated_sample.csv", sep = "\t")